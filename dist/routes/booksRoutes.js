...
module.exports = (app) => {
    ...
    app.post('/api/books/register', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const data = {
    ...
    app.get('/api/books/all', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const allBooks = yield Book.find({});
        res.json({ status: 200, result: allBooks });
    }));
    app.get('/api/books/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const id = req.params.id;
        const oneBook = yield Book.find({ _id: id });
        res.json({ status: 200, result: oneBook[0] });
    }));
    app.put('/api/books/update/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const id = req.params.id;
        const data = {
            title: req.body.title,
            author: req.body.author,
    ...
    app.delete('/api/books/delete/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const id = req.params.id;
